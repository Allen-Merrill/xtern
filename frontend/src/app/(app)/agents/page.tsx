...
const agentServices: ServerItem[] = [
  { id: '1', number: '01', serviceName: 'Demand Analyst', osType: 'ubuntu', serviceLocation: 'LangGraph Node \u00B7 Step 1', countryCode: 'us', ip: 'gpt-4o-mini', dueDate: 'Always On', cpuPercentage: 72, status: 'active' },
  { id: '2', number: '02', serviceName: 'Supplier Selector', osType: 'linux', serviceLocation: 'LangGraph Node \u00B7 Step 2', countryCode: 'us', ip: 'gpt-4o-mini', dueDate: 'Always On', cpuPercentage: 58, status: 'active' },
  { id: '3', number: '03', serviceName: 'Container Optimizer', osType: 'linux', serviceLocation: 'LangGraph Node \u00B7 Step 3', countryCode: 'de', ip: 'gpt-4o-mini', dueDate: 'Always On', cpuPercentage: 45, status: 'active' },
  { id: '4', number: '04', serviceName: 'PO Compiler', osType: 'windows', serviceLocation: 'LangGraph Node \u00B7 Step 4', countryCode: 'us', ip: 'gpt-4o-mini', dueDate: 'Always On', cpuPercentage: 33, status: 'active' },
];
  ...
  return (
    <div style={{ maxWidth: 1100 }}>
      ...
      <div className="animate-fade-up stagger-1">
        <ServerManagementTable title="Pipeline Agents" servers={agentServices} />
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12, marginTop: 20 }} className="animate-fade-up stagger-2">
